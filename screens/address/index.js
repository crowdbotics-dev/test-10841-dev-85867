...
const AddressScreen = ({
  ...
  return <ScrollView style={[styles.container]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.searchContainer}>
        ...
        <View style={[styles.inputText, styles.Apzcvqmi]}>
          <View style={styles.FKmRdLsg}>
